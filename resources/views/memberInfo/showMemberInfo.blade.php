                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2">
                                @if ($selectedMember->image_url)
                                    <img src="{{ $selectedMember->image_url }}" alt="Member Image" style="max-width: 150px;" class="rounded">
                                @else
                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2">
                                @if ($selectedMember->signature_url)
                                    <img src="{{ $selectedMember->signature_url }}" alt="Member Signature" style="max-width: 150px;" class="rounded">
                                @else
                                ...
                                <tr>
                                    ...
                                    <td class="border px-4 py-2">
                                        @if ($nominee->nominee_image)
                                            <img src="{{ asset('storage/' . $nominee->nominee_image) }}" alt="Nominee Image" style="max-width: 150px;" class="rounded">
                                        @else
                                            <p>No image available</p>
                                        @endif
                                    </td>
